      ...
      <div>
         ...
         <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-32 md:w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
               <div class="text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  <a href="https://www.wizrobotics.com/" class="flex items-center pl-2.5 mb-5">
                     ...
                     <Link to="https://www.wizrobotics.com/" class="self-center text-xl font-semibold whitespace-pre-wrap truncate">Wiz Robotics</Link>
                  </a>
               </div>
               <ul class="space-y-2">
                  <li>
                  ...
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="/DaisyPage" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Daisy Playground</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="https://www.notion.so/wizteam/Tailwind-CSS-2c225a5743594306add3b59e8335c373#4c68e3d84cde44e1b6bd87734680ea8e" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">Tailwind Doc</Link>
                     </div>
                  </li>
                  <li>
                     <div class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <Link to="https://www.notion.so/wizteam/Daisy-UI-4432159e733f4d2d905eb017027a7d09" class="flex-1 ml-3 whitespace-pre-wrap hover:text-violet-600 truncate">DaisyUI Doc</Link>
                     </div>
                  </li>
               </ul>
            </div>
