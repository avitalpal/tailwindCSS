      ...
      <a class="align-baseline font-bold text-sm text-violet-600 hover:text-violet-800" href="#">
        Forgot Password?
          ...
          <div class="pt-8 text-base font-semibold leading-7">
            <p class="text-gray-900">Need a reminder of DaisyUI's features?</p>
            <p>
              <a href="https://www.notion.so/wizteam/Daisy-UI-4432159e733f4d2d905eb017027a7d09" class="text-sky-500 hover:text-sky-600">Read the docs &rarr;</a>
            </p>
